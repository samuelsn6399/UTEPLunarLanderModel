...
## Generated on : Fri Sep 20 09:00:38 2024
## Final product: .\Flight_Controllers_PIL_rtwlib.lib
...
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = Flight_Controllers_PIL_rtwlib.lib
...
PRODUCT = .\Flight_Controllers_PIL_rtwlib.lib
...
SRCS = $(START_DIR)\slprj\ert\Flight_Controllers_PIL\Flight_Controllers_PIL.cpp
...
OBJS = Flight_Controllers_PIL.obj
...
LIBS = $(START_DIR)\slprj\ert\_sharedutils\sil\hostobj\rtwshared.lib
...
{$(START_DIR)\slprj\ert\Flight_Controllers_PIL}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Flight_Controllers_PIL}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Flight_Controllers_PIL}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\ert\Flight_Controllers_PIL}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Flight_Controllers_PIL.obj : "$(START_DIR)\slprj\ert\Flight_Controllers_PIL\Flight_Controllers_PIL.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\slprj\ert\Flight_Controllers_PIL\Flight_Controllers_PIL.cpp"
